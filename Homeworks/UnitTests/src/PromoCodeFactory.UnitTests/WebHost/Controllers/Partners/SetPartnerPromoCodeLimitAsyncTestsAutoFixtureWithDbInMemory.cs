...
{
    public class SetPartnerPromoCodeLimitAsyncTestsAutoFixtureWithDbInMemory
    {
        ...
        public SetPartnerPromoCodeLimitAsyncTestsAutoFixtureWithDbInMemory()
        {
            ...
            _fixture.Register<IRepository<Partner>>(() =>
                new EfRepository<Partner>(_context));
        ...
        public async Task SetPartnerPromoCodeLimit_PartnerHasLimit_ResettingPromoCodes(SetPartnerPromoCodeLimitRequest request)
        {
            ...
            Assert.Equal(0, _context.Partners.Single().NumberIssuedPromoCodes);
        }
        ...
        public async Task SetPartnerPromoCodeLimit_PartnerHasLimit_DisablingPreviousLimit(SetPartnerPromoCodeLimitRequest request)
        {
            ...
            Assert.NotNull(_context.Partners.Single().PartnerLimits.Single(l => l.Id == limit.Id).CancelDate);
        }
        ...
        public async Task SetPartnerPromoCodeLimit_PartnerHasNotLimit_PromoCodeNotResetting(SetPartnerPromoCodeLimitRequest request)
        {
            ...
            Assert.NotEqual(0, _context.Partners.Single().NumberIssuedPromoCodes);
        }
